...
public class ProcessoSeletivo {
    public static void main(String[] args) {
        String [] candidatos = {"FELIPE","MARCIA","JULIA","PAYLO","AUGUSTO"};
    ...
    static void imprimirSelecionados(){
        String [] candidatos = {"FELIPE","MARCIA","JULIA","PAYLO","AUGUSTO"};
        System.out.println("Imprimindo a lista de candidatos informmando o indice do elemento");
    ...
    static void selecaoCandidatos(){
        String [] candidatos = {"FELIPE", "MARCIA", "JULIA","PAULO","GUSTAVO","FABRICIO", "MIRELA", "DANIELA"};
